...
public class ApiTestGeneratorController {
	...
	@PostMapping(name = "CreatePostmanCollectionWithDataMap", value = "/createPostmanCollectionWithDataMap", 
			consumes = {MediaType.MULTIPART_FORM_DATA_VALUE }) // , MediaType.APPLICATION_JSON_VALUE
	public ResponseEntity<Resource> createPostmanCollection(
			@RequestPart(required = true, name = "apiSpec") @NotNull MultipartFile apiSpec, 
			@RequestPart(name = "apiData") @NotNull  HashMap<String, Object> dataMap) throws Exception { // @RequestParam(name = "apiData")
																				// Map<String, String> keyValuePairs
		System.out.println("Debug1: " + dataMap);
	...
	@PostMapping(name = "CreatePostmanCollectionWithDataMapAndFiles", value = "/createPostmanCollectionWithDataMapAndFiles", 
			consumes = { MediaType.MULTIPART_FORM_DATA_VALUE }) // , MediaType.APPLICATION_JSON_VALUE
	public ResponseEntity<Resource> createPostmanCollection(
			@RequestPart(required = true, name = "apiSpec") @NotNull MultipartFile apiSpec, 
