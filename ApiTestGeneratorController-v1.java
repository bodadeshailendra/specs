...
public class ApiTestGeneratorController {
	...
	public ResponseEntity<Resource> createPostmanCollection(
			@RequestPart(required = true, name = "apiSpec") @NotNull MultipartFile apiSpec,
			@RequestPart(name = "apiData") @NotNull HashMap<String, Object> dataMap) throws Exception {
	...
	@PostMapping(name = "CreatePostmanCollectionWithDataMapAndFiles", value = "/createPostmanCollectionWithDataMapAndFiles", consumes = {
			MediaType.MULTIPART_FORM_DATA_VALUE })
	public ResponseEntity<Resource> createPostmanCollection(
			@RequestPart(required = true, name = "apiSpec") @NotNull MultipartFile apiSpec,
			@RequestPart(name = "apiData") @NotNull HashMap<String, Object> dataMap,
			@RequestPart(name = "files") @Nullable List<MultipartFile> datafiles) throws Exception {

		File file;
		if (datafiles != null && !datafiles.isEmpty()) {
			file = autoTestGeneratorService.createPostmanCollectionWithDataMap(apiSpec, dataMap, datafiles);
		} else {
			file = autoTestGeneratorService.createPostmanCollectionWithDataMap(apiSpec, dataMap);
		}
	...
	public ResponseEntity<Resource> runPostmanCollection(
			@RequestPart(required = true, name = "postmanCollection") @NotNull MultipartFile postmanCollection,
			@RequestPart(name = "apiData") HashMap<String, Object> dataMap) throws Exception {
	...
	@PostMapping(name = "RunPostmanCollectionWithDataMapAndFiles", value = "/runPostmanCollectionWithDataMapAndFiles", consumes = {
			MediaType.MULTIPART_FORM_DATA_VALUE })
	public ResponseEntity<Resource> runPostmanCollection(

			@RequestPart(required = true, name = "postmanCollection") @NotNull MultipartFile postmanCollection,
			@RequestPart(name = "dataMap") @NotNull HashMap<String, Object> dataMap,
			@RequestPart(name = "dataFiles") @Nullable List<MultipartFile> dataFiles) throws Exception {

		File file;
		if (dataFiles != null) {
			if (!dataFiles.isEmpty()) {
				file = autoTestGeneratorService.runPostmanCollection(postmanCollection, dataMap, dataFiles);
			} else {
				file = autoTestGeneratorService.runPostmanCollection(postmanCollection, dataMap);
			}
		} else {
			file = autoTestGeneratorService.runPostmanCollection(postmanCollection, dataMap);
		}
